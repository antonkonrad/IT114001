...
public class GamePanel extends JPanel implements Event {
	...
	public void paintComponent(Graphics g) {
		...
		/*
		 * g.setColor(Color.YELLOW); // set the drawing color g.drawLine(30, 40, 100,
		 * 200); g.drawOval(150, 180, 10, 10); g.drawRect(200, 210, 20, 30);
		 * g.setColor(Color.RED); // change the drawing color g.fillOval(300, 310, 30,
		 * 50); g.fillRect(test.x, test.y, 60, 50);
		 */

		// Printing texts
		g.setColor(Color.WHITE);
		g.setFont(new Font("Monospaced", Font.PLAIN, 12));
		g.drawString("Battleship Testing: ", 10, 20);
