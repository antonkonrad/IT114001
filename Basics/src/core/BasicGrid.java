	...
	public static void main(String[] args) {
		...
		for (int y = 0; y < rows; y++) {
			for (int x = 0; x < cols; x++) {
				...
				// bt.setBackground(new Color(random.nextFloat(), random.nextFloat(),
				// random.nextFloat()));
				...
				bt.addActionListener(new ActionListener() {
					@Override
					public void actionPerformed(ActionEvent e) {
						// set the textfield value to the text value of the button to show clicked
						// coordinate
		...
		// set keybindings for navigation sample, may omit this and related
		// method/function
		// if not useful
